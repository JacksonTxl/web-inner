    ...
    methods: {
      ...
      getImgCode () {
        ...
        function getImgCodeInternal (param) {
          ...
          _this.$http.post(CONSTANT.basic.URL + '/captcha/resetpwd', params, headers).then(response => {
      ...
      sendPhoneCode () {
        ...
        function sendPhoneCodeInternal (param) {
          ...
          _this.$http.post(CONSTANT.basic.URL + '/register/resetpwdcode', params, headers).then(response => {
            response.text().then(function (value) {
              var data = JSON.parse(value);
      ...
      commit () {
        ...
        function commitInternal (param) {
          ...
          _this.$http.post(CONSTANT.basic.URL + '/register/resetpwd', params, headers).then(response => {
            response.text().then(function (value) {
              var data = JSON.parse(value);
